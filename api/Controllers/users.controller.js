    ...
    try {
        ...
        if (user) {
            ...
            if (req.body.password !== req.body.confirmPassword) {
                return next(createError(422, "Password didn't matches. Please try again"));
            }
                    ...
                    registerUser.save()
                        ...
                        .catch(error => {
                            ...
                            if (error.name === 'ValidationError') {
                                next(createError(422, 'May be your email and Password is not in correct form'));
                                return;
                            }
                            next(error);
                        });
    ...
    try {
        ...
        if (!user) {
            ...
            bcrypt.compare(req.body.password, user.password, (err, result) => {
                if (err) {
                    next(createError(401,'Authorization fa'));
                } 
                else if(!result){
